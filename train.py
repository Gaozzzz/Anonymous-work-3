...
def parse_args():
    parser = argparse.ArgumentParser(description='Let\'s go TPNet')
    parser.add_argument('--dataset', default='.../colon_video_features')
    parser.add_argument('--save_path', default='.../experiment')
